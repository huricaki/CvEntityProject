...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Huri Çakı</a></h1>
            <p class="top_hdp mt-2">Elektrik-Elektronik Mühendisi</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#news" class="scroll">İş Deneyimleri</a></li>
    ...
    <div class="main">
            ...
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <p class="banp mx-auto mt-3">
                        <asp:Repeater ID="Repertar1" runat="server">
                            <ItemTemplate>
                                <%# Eval("Bilgiler") %>
                            </ItemTemplate>
                        </asp:Repeater>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <p class="iner mt-md-5">
                <asp:Repeater ID="Repertar2" runat="server">
                    <ItemTemplate>
                        <%# Eval("Egitim") %>
                    </ItemTemplate>
        ...
        <section class="services" id="services">
            <div class="container">
                ...
                <ul class="list-unstyled mt-5">
                    <li>
                        <asp:Repeater ID="Repertar4" runat="server">
                            <ItemTemplate>
                                <div class="row">
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">İş Deneyimleri</h3>
            <p class="iner mt-md-5 text-left"></p>
            <asp:Repeater ID="Repertar3" runat="server">
                <ItemTemplate>
                    <%# Eval("Deneyimler") %>
                </ItemTemplate>
        ...
        <section class="wedo" id="contact">
            <h3 class="w3_head mb-4 text-left">İletişim</h3>
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox3" runat="server" placeholder="Mesajınız" TextMode="MultiLine" Height="30"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Gönder" OnClick="Button1_Click" />
