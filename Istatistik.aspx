<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Istatistik.aspx.cs" Inherits="CvEntityProject.Istatistik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="total-world">
        ...
        <div class="site-report">
            ...
            <p>Entity CV  projemizin admin paneli kısmındasınız. Kütüphane Sistemi size iyi okumalar diler.</p>
        </div>
        <div class="clearfix"></div>
    </div>
